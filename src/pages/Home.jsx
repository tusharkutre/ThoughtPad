      ...
      <div className="w-full h-full py-10 max-w-[1200px] mx-auto px-5 lg:px-0">
        <div className="flex flex-col gap-y-5 items-start">
          ...
          <div className="w-[100%] flex flex-row gap-x-4 justify-between items-center">
            ...
            />
            <button
              className="text-white w-1/2 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm py-3 px-4 dark:bg-blue-600 dark:hover:bg-blue-700"
              onClick={createPaste}
            >
